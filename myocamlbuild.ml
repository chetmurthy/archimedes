(* OASIS_START *)
(* DO NOT EDIT (digest: f78d39322a9fe7ac32d19ff2d4e586e2) *)
...
let package_default =
  {
     MyOCamlbuildBase.lib_ocaml =
       [
          ("archimedes_internals", ["src"]);
          ("archimedes", ["src"]);
          ("archimedes_graphics", ["src"]);
          ("archimedes_cairo", ["src"]);
          ("archimedes_tikz", ["src"]);
          ("archimedes_toploop", ["src"])
       ];
     lib_c = [];
     flags =
       [
          (["oasis_library_archimedes_toploop_byte"; "ocaml"; "link"; "byte"],
            [(OASISExpr.EBool true, S [A "-I"; A "+compiler-libs"])]);
          ([
              "oasis_library_archimedes_toploop_native";
              "ocaml";
              "link";
              "native"
           ],
            [(OASISExpr.EBool true, S [A "-I"; A "+compiler-libs"])]);
          ([
              "oasis_library_archimedes_toploop_byte";
              "ocaml";
              "ocamldep";
              "byte"
           ],
