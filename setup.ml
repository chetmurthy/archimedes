(* OASIS_START *)
(* DO NOT EDIT (digest: 9460c752339d38b6527385fa0251cfcb) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          description =
            Some
              [
                 OASISText.Para
                   "Archimedes is a high quality, platform-independent, extensible 2D plotting library.  It provides dynamically loaded backends such as Graphics and Cairo."
              ];
          categories = [];
            ...
            [
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "Use the graphics plugin?";
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "Use the cairo (PNG, PS, PDF) plugin?";
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "Use the tikz (TeX) plugin?";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Library
                 ({
                     cs_name = "archimedes_internals";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   },
                   {
                      ...
                      lib_findlib_parent = Some "archimedes";
                      lib_findlib_name = Some "internals";
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage ("dynlink", None);
                           FindlibPackage ("bigarray", None);
                           InternalLibrary "archimedes_internals"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           InternalLibrary "archimedes"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [("archimedes_graphics.dep", None)];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                      bs_cclib = [(OASISExpr.EBool true, [])];
                      bs_dlllib = [(OASISExpr.EBool true, [])];
                      bs_dllpath = [(OASISExpr.EBool true, [])];
                   ...
                   {
                      lib_modules = ["Archimedes_graphics"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "archimedes";
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [("archimedes_cairo.dep", None)];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                      bs_cclib = [(OASISExpr.EBool true, [])];
                      bs_dlllib = [(OASISExpr.EBool true, [])];
                      bs_dllpath = [(OASISExpr.EBool true, [])];
                   ...
                   {
                      lib_modules = ["Archimedes_cairo"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "archimedes";
                      lib_findlib_name = Some "cairo";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "archimedes_tikz";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      bs_build =
                        [
                           (OASISExpr.EBool true, false);
                           (OASISExpr.EFlag "tikz", true)
                        ];
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "src";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "archimedes"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {
                      lib_modules = ["Archimedes_tikz"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "archimedes";
                      lib_findlib_name = Some "tikz";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "archimedes_toploop";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      lib_modules = ["Archimedes_toploop"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "archimedes";
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "API reference for Archimedes";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "pythagoras_tree.ml"});
               Executable
                 ({
                     cs_name = "coordinate_pairs";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "coordinate_pairs.ml"
                   });
               Executable
                 ({
                     cs_name = "pkg_chart";
                   ...
                   {exec_custom = false; exec_main_is = "pkg_chart.ml"});
               Executable
                 ({
                     cs_name = "anscombe";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "anscombe.ml"});
               Executable
                 ({
                     cs_name = "scatter_hist";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "scatter_hist.ml"});
               Executable
                 ({
                     cs_name = "coords_report.ml";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "coords_report.ml"});
               Executable
                 ({
                     cs_name = "taylor.ml";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "taylor.ml"});
               Executable
                 ({
                     cs_name = "spiral.ml";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "spiral.ml"});
               Executable
                 ({
                     cs_name = "multi_hue.ml";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "multi_hue.ml"});
               Executable
                 ({
                     cs_name = "files_pie.ml";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "files_pie.ml"});
               Executable
                 ({
                     cs_name = "incremental_drawing.ml";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "incremental_drawing.ml"
                   });
               SrcRepo
                 ({
                     cs_name = "trunk";
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "http://forge.ocamlcore.org/anonscm/git/archimedes/archimedes.git";
                      src_repo_browser =
                        Some
                          "https://forge.ocamlcore.org/scm/browser.php?group_id=105";
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "\191\211#\233<\0122]QK\223\249\235\196\159\141";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
